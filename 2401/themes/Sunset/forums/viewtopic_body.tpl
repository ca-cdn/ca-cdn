...
<img src="themes/Sunset/forums/images/spacer.gif" alt="" width="150" height="1" />
</td>
...
<td nowrap="nowrap" valign="top">{postrow.QUOTE_IMG} {postrow.EDIT_IMG} <a href="#top"><img src="themes/Sunset/forums/images/icon_up.gif" width="16" height="18" border="0" alt="{L_BACK_TO_TOP}" title="{L_BACK_TO_TOP}" /></a>
...
<tr>
<td class="spacerow" colspan="2" height="1"><img src="themes/Sunset/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
</tr>
<!-- END postrow -->
<tr>
