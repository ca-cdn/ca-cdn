...
function themeheader() {
		global $user, $banners, $sitename, $slogan, $cookie, $prefix, $db, $anonymous, $nukeurl, $module_name, $admin, $name, $index, $admin_file, $slogan, $nukeNAV;
		if ($user != '') {
			cookiedecode($user);
			$username = $cookie[1];
		}
...
echo ads(0);
		...
		echo '<br />'."\n";
		echo '<table cellpadding="0" cellspacing="0" width="750" border="0" align="center" bgcolor="#ffffff">'."\n"
		.'<tr><td>'.$nukeNAV.'</td></tr>'
		.'<tr>'."\n"
		...
		.'<tr>'."\n"
		.'<td bgcolor="#f3e1af">'."\n"
		.'<img src="themes/Karate/images/tophighlight.gif" alt="" /></td>'."\n"
		.'</tr>'."\n"
		.'</table>'."\n"
		.'<table cellpadding="0" cellspacing="0" width="750" border="0" align="center" bgcolor="#ffffff">'."\n"
		.'<tr valign="middle">'."\n"
		...
		.'<tr>'."\n"
		.'<td bgcolor="#000000" colspan="4"><img src="themes/Karate/images/pixel.gif" width="1" style="height: 1px" alt="" border="0" hspace="0" /></td>'."\n"
		.'</tr>'."\n"
		.'<tr valign="middle" bgcolor="#efce6b">'."\n"
		.'<td width="15%" nowrap="nowrap"><font class="content" color="#363636">'."\n";
		if ($username == "$anonymous") {
		echo '&nbsp;&nbsp;<font color="#363636"><a href="modules.php?name=Your_Account">'._LOGIN.'</a></font>'."\n";
		} else {
		...
		.'<tr valign="top">'."\n"
		.'<td bgcolor="#f3e1af"><img src="themes/Karate/images/pixel.gif" width="1" style="height: 3px" border="0" alt="" /></td>'."\n"
		.'</tr>'."\n"
		.'<tr valign="top">'."\n"
		.'<td bgcolor="#ffffff"><img src="themes/Karate/images/pixel.gif" width="1" style="height: 5px" border="0" alt="" /></td>'."\n"
		.'</tr>'."\n"
		.'</table>'."\n"
;
		...
		blocks("l");
		echo '</td><td><img src="themes/Karate/images/pixel.gif" width="15" style="height: 1px" border="0" alt="" /></td><td width="100%">'."\n";
}
...
function themefooter() {
		...
		echo '</td><td><img src="themes/Karate/images/pixel.gif" width="15" style="height: 1px" border="0" alt="" /></td><td valign="top" width="150" bgcolor="#eeeeee">'."\n";
		blocks("r");
		}
		echo '</td>'."\n"
		.'</tr></table>'."\n"
				...
				.'<tr>'."\n"
				.'<td width="750" style="height: 5px"><img src="themes/Karate/images/bottombar.gif" width="750" style="height: 5px" border="0" alt="" /></td>'."\n"
				.'</tr>'."\n"
				.'<tr>'."\n"
				.'<td width="100%"><img src="themes/Karate/images/pixel.gif" width="1" style="height: 1px" border="0" alt="" /></td>'."\n"
				.'</tr>'."\n"
				.'</table>'."\n"
				.'<br />'."\n"
				.'<br />'."\n"
