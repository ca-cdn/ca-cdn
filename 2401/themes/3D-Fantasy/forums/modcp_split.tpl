...
<tr>
<td class="postdetails"><img src="themes/3D-Fantasy/forums/images/icon_minipost.gif" alt="{L_POST}" title="{L_POST}" width="12" height="9" />{L_POSTED}:
...
<tr>
<td colspan="3" height="1" class="spacerow"><img src="themes/3D-Fantasy/forums/images/spacer.gif" width="1" height="1" alt="" /></td>
</tr>
<!-- END postrow -->
<tr>
