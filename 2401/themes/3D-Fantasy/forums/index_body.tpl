...
<tr>
<td class="row1" rowspan="3"><img src="themes/3D-Fantasy/forums/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" title="{L_WHO_IS_ONLINE}" width="33" height="25" />
</td>
...
<tr>
<td><img src="themes/3D-Fantasy/forums/images/folder_new.gif" alt="{L_NEW_POSTS}" title="{L_NEW_POSTS}" width="33" height="25" /></td>
<td class="gensmall">{L_NEW_POSTS}</td>
<td>&nbsp;</td>
<td><img src="themes/3D-Fantasy/forums/images/folder.gif" alt="{L_NO_NEW_POSTS}" title="{L_NO_NEW_POSTS}" width="33" height="25" /></td>
<td class="gensmall">{L_NO_NEW_POSTS}</td>
<td>&nbsp;</td>
<td><img src="themes/3D-Fantasy/forums/images/folder_lock.gif" alt="{L_FORUM_LOCKED}" title="{L_FORUM_LOCKED}" width="33" height="25" /></td>
