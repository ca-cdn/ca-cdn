...
function themeheader() {
	...
	if (empty($nukeNAV)) 
	 $navMenu = '<font class="content">&nbsp;&#8226;&nbsp;<a href="index.php">'._HOME.'</a>&nbsp;&#8226;&nbsp;<a href="modules.php?name=Downloads">'._UDOWNLOADS.'</a>&nbsp;&#8226;&nbsp;<a href="modules.php?name=Your_Account">'._FSIYOURACCOUNT.'</a>&nbsp;&#8226;&nbsp;<a href="modules.php?name=Forums">'._BBFORUMS.'</a>&nbsp;&#8226;&nbsp;'.$logoutMenu.$adminMenu.'</font>';
